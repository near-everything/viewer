...
const tabs = [
  {
    ...
    module: () => (
      // TODO: I want this to come from the Thing.
      <>
        <Widget
...
const { metadata } = data;
const { name, description, image, backgroundImage } = projectData;
...
return (
  <>
    ...
    {edit ? (
      <>
        <Widget
          src="every.near/widget/view.editor"
          props={{ path: `${creatorId}/thing/${projectId}` }}
        />
      </>
    ) : (
      <>
